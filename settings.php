 ...
 * @endcode
 */
$settings['hash_salt'] = 'xmX6WkeiAWZMItNJQjPi5IKThReWF8O2Up5Wje8O3gLLNvCDWCGHRfx02ps7SkYIRn-M5ioTqA';
...
$settings['config_sync_directory'] = 'sites/default/files/config_xfAoAkjeTMLTrcYzv-0LASfYPumOBnlQ3iOGaYhVWt0xXeftlvypb8dkAIROqLyuTfjeQXUOWw/sync';
$settings['trusted_host_patterns'] = [
'^localhost$',                              
'^192\.168\.00\.52$',
'^127\.0\.0\.1$',
