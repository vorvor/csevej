 ...
 */
function csevej_form_system_theme_settings_alter(&$form, \Drupal\Core\Form\FormStateInterface &$form_state, $form_id = NULL) {
  ...
  $form['csevej_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('csevej sample setting'),
  '#default_value' => theme_get_setting('csevej_example'),
